...
try {
    ...
    if (!$tableExists) {
        ...
        echo "<p><strong>Solución:</strong> Ejecuta el archivo <code>agregar_tabla_pagos.sql</code> en phpMyAdmin</p>";
        echo "<ol>";
        echo "<li>Abre phpMyAdmin</li>";
        echo "<li>Selecciona la base de datos 'cooperativa_agricola'</li>";
        echo "<li>Ve a la pestaña 'SQL'</li>";
        echo "<li>Copia y pega el contenido de <code>agregar_tabla_pagos.sql</code></li>";
    ...
    echo "<p>Ahora puedes usar el módulo de pagos en <code>dashboard.html</code></p>";
    ...
    echo "<li>Ejecuta el archivo <code>agregar_tabla_pagos.sql</code> en phpMyAdmin</li>";
    echo "</ol>";
}
?>
